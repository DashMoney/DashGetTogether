...
class CreateGroupModal extends React.Component {
  ...
  render() {
    ...
    if (this.props.mode === "primary") {
      ...
      closeButtonColor = <CloseButton onClick={() => this.props.hideModal()} />;
    } else {
      modalBkg = "modal-backcolor-dark";
      closeButtonColor = (
        <CloseButton onClick={() => this.props.hideModal()} variant="white" />
      );
    }
    ...
    return (
      <>
          ...
          <Modal show={this.props.isModalShowing} contentClassName={modalBkg}>
            <Modal.Header>
              <Modal.Title><b>Create New Group</b></Modal.Title>
              {closeButtonColor}
            </Modal.Header>
            <Modal.Body>

              <Form noValidate onChange={this.onChangeForm} onSubmit={this.handleSubmitClick}>
              ...
              Group name is acceptable!
                    ...
                    <ul>
                      <li>
                        You can create a group name of any alphanumberic or spaces that you like.
                      </li>
                      <li>
                        What you will find interesting is that if a group already exists with that name then you will simply join it!
                      </li>
